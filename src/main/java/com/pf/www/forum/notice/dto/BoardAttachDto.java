...
public class BoardAttachDto {
	...
	public static BoardAttachDto setBoardAatachDto(HashMap<String, String> params, MultipartFile mf, File destFile) {
		
		BoardAttachDto attachDto = new BoardAttachDto();
		attachDto.setBoardSeq(Integer.parseInt(params.get("boardSeq")));
		attachDto.setBoardTypeSeq(Integer.parseInt(params.get("boardTypeSeq")));
		attachDto.setOrgFileNm(mf.getOriginalFilename());
		attachDto.setChngFileNm(params.get("unqFileNm"));
